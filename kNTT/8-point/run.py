...
runner.memcpy_d2h(y_result, y_symbol, 0, 0, 8, 1, 8, streaming=False,
  order=MemcpyOrder.ROW_MAJOR, data_type=MemcpyDataType.MEMCPY_32BIT, nonblock=False)
...
# TODO [pokuk76]: For some reason there's just 8 extra rows of 0s
print(f"y_result = {y_result.reshape(16, 8)}")
